...
Problem: A manufacturing company has classified its executives into four levels for the benefit of certain perks. The levels and corresponding 
         perks are shown below: 

      Level             |__________________________________ Perks ______________________________________|
________________________|_______ Conveyance allowance ________|_________ Entertainment allowance________|
 1                      |               1000                  |                 500                     |
 2                      |                750                  |                 200                     | 
 3                      |                500                  |                 100                     | 
 4                      |                250                  |                  _                      |  

An executive's gross salary includes basic pay, house rent allowance at 25% of basic pay and other perks. Income tax is withheld from the salary 
on a percentage basis as follows: 
 ___________________________________________________________________
|__________ Gross salary__________|___________ Tax rate_____________|
...
Program: A program and the results of the test data are given below. Note that the last statement should be an executable statement. That is, the 
label stop: cannot be the last line. 
*/
#include<stdio.h>
#define CA1 1000 
#define CA2 750 
